...
export const localized = new LocalizedStrings({
    ...
    de: {
        ...
        error: "Fehler",
        createPlaylistNameError: "Der Name der Wiedergabeliste kann nur Buchstabeln, Zahlen und Leerzeichen enthalten.",
        ...
        newTabText: "Du bist dabei, einen Link von {0} in einer neuen Tab zu öffnen.\nSind Sie sicher? Diese Seite hat nichts mit Ossia in Verbindung zu bringen.",

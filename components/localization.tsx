...
export const localized = new LocalizedStrings({
    ...
    hu: {
        ...
        inviteCode: "Meghívó",
        inviteCodeDesc: " Egy kód amit egy regisztrált felhasználótól kaphatsz, vagy vásárolhatsz egyet.",
        inviteCodeInvalid: "A meghívó érvénytelen!",
        inviteSalesPitch: "Ezzel az egyszeri vásárlással regisztrálhatsz az Ossia-ra és hozzáférést kaphatsz az összes funkcióhoz amit az applikációnk kínál.",
        login: "Bejelentkezés",

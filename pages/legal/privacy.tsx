    ...
    return (<Container>
        ...
        <TypographyStylesProvider>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Ossia, accessible from <a href="https://ossia.ml" rel="external nofollow noopener" target="_blank">https://ossia.ml</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: <a href="mailto:shibibence+ossia@gmail.com">shibibence+ossia@gmail.com</a></li>
            </ul>
        </TypographyStylesProvider>
    </Container>)
}
